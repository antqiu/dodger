...
String[] BRC_ids = new String[] {"start","restart","speed","size","colors","bg"};
String[] BRC_values = new String[] {"0","0","S","S","R","B"};

String[] BRC_Monitors = new String[] {"score","highest"};
String[] BRC_MonitorValues = new String[] {"N/A","N/A"};
...
+ "[\"BUTTON\",\"brc_2\",\"restart\"],\n"
+ "[\"RADIO\",\"brc_3\",\"speed\"],\n"
+ "[\"RADIO\",\"brc_4\",\"size\"],\n"
+ "[\"DROPDOWN\",\"brc_5\",\"colors\"],\n"
+ "[\"DROPDOWN\",\"brc_6\",\"bg\"],\n"
+ "[\"MONITOR\",\"brc_7\",\"score\"],\n"
+ "[\"MONITOR\",\"brc_8\",\"highest\"]];\n"
+ "\n"
+ "Monitor = true;\n"
+ "\n"
+ "function Sendall() {\n"
...
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td><td><table cellpadding=\"3\"><tr><td class=\"auto-style1\">difficulty:&nbsp;&nbsp;&nbsp;\n"
+ "<input type=\"radio\" name=\"brc_3\" value=\"L\" onclick=\"SendNameValue('speed=L');\"   /> fast&nbsp;&nbsp;&nbsp;\n"
+ "<input type=\"radio\" name=\"brc_3\" value=\"M\" onclick=\"SendNameValue('speed=M');\"   /> medium&nbsp;&nbsp;&nbsp;\n"
+ "<input type=\"radio\" name=\"brc_3\" value=\"S\" onclick=\"SendNameValue('speed=S');\"  checked=\"checked\" /> slow&nbsp;&nbsp;&nbsp;\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table cellpadding=\"3\"><tr><td class=\"auto-style1\">enemy_size:&nbsp;&nbsp;&nbsp;\n"
+ "<input type=\"radio\" name=\"brc_4\" value=\"S\" onclick=\"SendNameValue('size=S');\"  checked=\"checked\" /> small&nbsp;&nbsp;&nbsp;\n"
+ "<input type=\"radio\" name=\"brc_4\" value=\"M\" onclick=\"SendNameValue('size=M');\"   /> medium&nbsp;&nbsp;&nbsp;\n"
+ "<input type=\"radio\" name=\"brc_4\" value=\"L\" onclick=\"SendNameValue('size=L');\"   /> large&nbsp;&nbsp;&nbsp;\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">target_colors:&nbsp;&nbsp;&nbsp;\n"
+ "<select name=\"brc_5\" id=\"brc_5\" onchange=\"SendNameValue('colors='+document.brc.brc_5.value);\">\n"
...
+ "</select></td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">background:&nbsp;&nbsp;&nbsp;\n"
+ "<select name=\"brc_6\" id=\"brc_6\" onchange=\"SendNameValue('bg='+document.brc.brc_6.value);\">\n"
+ "<option  value=\"S\">sky</option>\n"
+ "<option selected=\"selected\" value=\"B\">black</option>\n"
+ "<option  value=\"SP\">space</option>\n"
+ "</select></td></tr></table>\n"
+ "\n"
+ "</td><td><table><tr><td class=\"auto-style1\">time_lived <label id=\"brc_7\" class=\"monitor\">N/A</label>\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table><tr><td class=\"auto-style1\">high_score <label id=\"brc_8\" class=\"monitor\">N/A</label>\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td></tr></table>\n"
+ "\n"
